...
- `RadioBOSS-SongSync-v1.6.0.zip` for the recommended
  Windows EXE
...
Run `RadioBOSS-SongSync-Setup.exe`, complete the database and optional SFTP
tests, and save the configuration. The setup application creates the private
`config.py` file beside the executable.

Manual configuration remains available in
